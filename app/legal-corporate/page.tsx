                ...
                <ScrollReveal>
                    <div className="max-w-5xl mx-auto text-center">
                        <p className="text-xl md:text-2xl text-gray-700 leading-relaxed font-light">
                            Entering the UAE market demands precision and foresight. The Royal Union delivers end-to-end legal and corporate services, ensuring foreign businesses comply with Dubai's dynamic regulations while optimizing for growth.
                        </p>
                    </div>
                </ScrollReveal>
            </Section>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <ScrollReveal delay={0.1}>
                            <div className="bg-white rounded-xl shadow-lg overflow-hidden border-t-8 border-royal-gold hover:-translate-y-2 transition-transform duration-300 flex flex-col group">
                        ...
                        <ScrollReveal delay={0.2}>
                            <div className="bg-white rounded-xl shadow-lg overflow-hidden border-t-8 border-royal-gold hover:-translate-y-2 transition-transform duration-300 flex flex-col group">
                                <div className="h-64 overflow-hidden relative">
                                    <img src="/images/legal-corporate/advisory.jpg" alt="Compliance and Advisory" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                                    <div className="absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors duration-500" />
                                </div>
                                <div className="p-10 flex-1 flex flex-col">
                ...
                <ScrollReveal>
                    <div className="container mx-auto px-6 text-center">
                        <p className="text-2xl md:text-3xl font-serif text-foreground mb-12 max-w-4xl mx-auto">
                            Build a solid foundation in Dubai with us. Reach out to forge a powerful alliance.
                        </p>
